...
$user_id = "";
// connect to database
$db = mysqli_connect('localhost', 'root', 'toby', 		'registration');
...
<html>
<h1>
Hi their, click this link to reset your password on our site!
</h1>
<a href="localhost/new_password.php?token=" . $token . ">link</a>
</html>
';
